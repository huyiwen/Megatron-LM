#!/bin/bash
cd /cpfs01/user/wenxian.hyw/Megatron-LM
source /cpfs01/user/wenxian.hyw/Megatron-LM/.venv/bin/activate
...
# Logs and datasets
CHECKPOINT_PATH=/cpfs01/user/wenxian.hyw/hyw/exp/deepseek_moe/${JOB_ID:-standalone}
TENSORBOARD_LOGS_PATH=$CHECKPOINT_PATH
DATA_PATH=/cpfs01/user/wenxian.hyw/hyw/dataset/17_20241108_004951_input_ids_document
